...
# -----------------------------------------------------------------------------
# Lasso AWS Bedrock Converse example using a custom AWS session.
#
# This example sends Bedrock Runtime requests to the Lasso proxy. Lasso then
# forwards the request to Amazon Bedrock.
#
# Auth flow:
#   1. The app creates an explicit AWS credentials object.
#   2. The AWS SDK signs the Bedrock request with those credentials.
...
# -----------------------------------------------------------------------------
# 2. Create a custom AWS credentials object
# -----------------------------------------------------------------------------
...
client = Aws::BedrockRuntime::Client.new(
  ...
  # Custom credentials used by this client only.
