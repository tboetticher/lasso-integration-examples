"""
Simple AWS Bedrock Converse conversation example through the Lasso proxy.
    ...
    messages.append(
        {
            ...
            "content": [
                {
                    "text": "I am learning how to use AWS Bedrock through the Lasso proxy."
                }
            ],
        }
    )
    ...
    messages.append(
        {
            ...
            "content": [
                {
                    "text": "Can you summarize what I just told you in one sentence?"
                }
            ],
        }
    )
