"""
Simple AWS Bedrock embedding request using invoke example through the Lasso proxy.
...
native_request = {"inputText": "What is the ultimate answer to life, the universe, and everything?"}
